...
<!---- Content Ares Start  -------->
    ...
    <!----------------   Menu Tab   --------------->
        <div class="panel panel-default contentinside">
                <div class="panel-heading" style="font-size: 22px; font-weight: bold;">Manage Pharmaceuticals</div>
                
                <div class="form-group">
        
               <!----------------------------Search  -------------------------------> 
               <form action="search_pharmaceutical.jsp" method="post">
...
<%
	...
	PreparedStatement ps=c.prepareStatement("select * from pharmaceutical",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
	rs=ps.executeQuery();
	while(rs.next())
	{
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                             <form class="form-horizontal" action="edit_pharmaceutical_validation.jsp" method="post">
                                ...
                                <div class="form-group">
                                <label  class="col-sm-2 control-label">Stock Sufficient (Days)</label>
                                <div class="col-sm-10">
