...
<%
	...
	PreparedStatement ps=c.prepareStatement("select * from patient_info where pname like '%"+searchString+"%' or ward_no like '%"+searchString+"%' or address like '%"+searchString+"%'",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
	rs=ps.executeQuery();
	while(rs.next())
	{
		id=rs.getInt(1);
