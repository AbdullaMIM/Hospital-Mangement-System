				...
				<div class="panel panel-default login">
					...
					<div class="panel-heading logintitle">SIGN IN</div>
					  <div class="panel-body">
                        ...
                        <div>                                                 
				              ...
				              <div class="input-group input-group-lg">
					             <span class="input-group-addon" id="sizing-addon1"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span></span>
						             <input type="email" class="form-control" name="email" placeholder="user@gmail.com" required aria-describedby="sizing-addon1">
				              </div>  <br/>
		               ...
		               <a href="patient_register.jsp" style="text-align:Center;font-weight:bold;font-size:140%;padding: 20px">Register As Patient</a>	 <br>
		               <div style="text-align:center;font-weight:bold; font-size: 20px; color:red">Login Failed. Check Your Username or Password.</div> <br>
