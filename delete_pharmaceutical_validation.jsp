...
<%
        ...
        PreparedStatement ps=con.prepareStatement("delete from pharmaceutical where id=?");
        ...
        <div class="container-fluid">
		 ...
		 <!------------------------------------- Header Ends Here --------------------------------------------------->
		    ...
		    <div style=" margin-top: -200px; margin-left: 400px;  height: 300px; width:700px; background-color:#276B9C; color: #fff; ">
		             <p style="text-align: center; padding: 85px 0px 40px 0px; font-weight:bold; font-size: 25px; font-family: sans-serif">PHARMACEUTICAL DETAILS DELETED SUCCESSFULLY.</p>
